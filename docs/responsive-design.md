...
Als je een squadpage ontwerpt moet je ervoor zorgen dat het op alle apparaten goed werkt. Heb web is niet een statische plek qua verhoudingen, zoals een krant of magazine, elk device en elk scherm kan weer een eigen verhouding hebben.

Met responsive design zorg je ervoor dat jouw website het op alle apparaten, met allemaal veschillend groottes, andere schermen en verhoudingen, het goed doet.

![responsive deisgn](responsive-design.jpg)

### Schermgroottes en pixels
Wat voor verschillende apparaten en pixels hebben jullie in je team?

#### Opdracht
1. Zoek de pixelwaardes van alle apparaten aan de tafel op
...
Naast dat je de devtools kunt gebruiken kun je natuurlijk ook met je browser heen en weer slepen om te kijken wat er gebeurt op verschillende verhoudingen. Als je de devtools open hebt staan, kun je als je heen en weer sleept ook de pixel waardes zien in de rechterbovenhoek van je website.
...
2. Zoek uit op welke pixelwaardes de site een andere layout laat zien
...
1. Maak in je Learning journal een html file aan, noem het "mediaquery.html"
2. Maak een CSS file aan, noem dit "style.css" en koppel het aan het HTML file
3. Geef het document een achtergrond kleur. Voeg dit bijvoorbeeld toe aan je CSS: 
...
5. Voeg een _media query_ toe aan het CSS om de achtergrond kleur te veranderen bij een bepaalde breedte
...
### Breakpoints en Breakdown schets van de squadpage
